$(document).ready(function () {
    ...
    $('#validate').on('click', function (e) {
        ...
        var submitForm = true;
        if (qp_form_validation('#cedula_p', 'numeric') !== true) {
            submitForm = false;
        }
        if (qp_form_validation('#nombre_p', 'alphabet') !== true) {
            submitForm = false;
        }
        else {
            $('#nombre_p').removeClass('border-danger');
        }


        if (qp_form_validation('#apellido_p', 'alphabet') !== true) {
            submitForm = false;
        }
        else {
            $('#apellido_p').removeClass('border-danger');
        }

        ///
        if (qp_form_validation('#telefono_p', 'numeric') !== true) {
            submitForm = false;
        }else
        {
            $('#telefono_p').removeClass('border-danger');
        }


        if (qp_form_validation('#name', 'alphanumeric') !== true) {
            submitForm = false;
        }else
        {
        ...
        if (qp_form_validation('#direccion_p', 'alphanumeric') !== true) {
            submitForm = false;
        }else
        {
            $('#direccion_p').removeClass('border-danger');
        }
