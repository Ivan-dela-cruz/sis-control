...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="font-italic pull-right"><a href="{{route('equipos.index')}}">Equipos</a>/Editar equipo
                - {{$equipo->serie_e}} </p>
        </div>
    </div>
    <div class="row mb-5">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <button class="searchInput btn btn-primary" type="button">Cambiar cliente</button>
                                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="col-md-5 mx-5">
                                    <div class="form-group">
                                        <p><b>Nombre cliente: </b>
                                            &nbsp;&nbsp;&nbsp;&nbsp; <label
                                                    class="nom_cli">{{$user->nombre_p}}  {{$user->nombre_p}}</label></p>
                                        <input hidden id="ordencliente" type="text">
                                    </div>
                                    <div class="form-group">
                                        <p><b>N° Cédula: </b>
                                            &nbsp;&nbsp;&nbsp;&nbsp; <label class="ci_cli"> {{$user->cedula_p}}</label>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-5 mx-5">
                                    ...
                                    <div class="form-group">
                                        <p><b>Dirección cliente: </b>
                                            &nbsp;&nbsp;&nbsp;&nbsp;<label class="dir_cli">
                                                {{$user->direccion_p}}</label>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <p><b>Télefono: </b>
                                            &nbsp;&nbsp;&nbsp;&nbsp;<label
                                                    class="tlf_cli"> {{$user->telefono_p}}</label></p>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <input type="hidden" name="id_p" id="id_p" class="cliente-equipo" value="{{$user->id}}">
