        ...
        <div class="col-md-6 col-lg-6 col-xl-4 mb-5">
            <div class="card card-md">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="card-chart" data-chart-color-1="#07a7e3" data-chart-color-2="#32dac3"
                         data-chart-color-3="#4f5b60" data-chart-color-4="#FCCF31"
                ...
                <div class="col-sm-12">
                    <div class="card card-sm bg-primary bg-gradient text-center">
                        <div class="card-body">
                            ...
                            <div class="card-chart" data-chart-color-1="#FFFFFF"
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-sm bg-secondary bg-gradient text-center">
                        <div class="card-body">
                            <div class="card-chart" data-chart-color-1="#FFFFFF"
                                 data-chart-color-2="#FFFFFF" data-chart-color-2="#FFFFFF">
                    ...
                    <ul class="task-list">
                        <li class="task-list-item">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label">Mauris rutrum quam at porta
                                    feugiat</label>
                            </div>
                        </li>
                        <li class="task-list-item">
                        ...
                        <li class="task-list-item">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label"><span
                                            class="badge badge-warning">High Priority</span>Aliquam
                        ...
                        <li class="task-list-item">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" checked>
                                <label class="custom-control-label">Etiam varius neque sed sagittis
                                    fringilla</label>
                            </div>
                        </li>
                        <li class="task-list-item">
                        ...
                        <li class="task-list-item">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input">
                                <label class="custom-control-label"><span
                                            class="badge badge-warning">High Priority</span>Fusce
                                    in felis nec exdf</label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="custom-control custom-checkbox">
            ...
            <div class="card card-activity card-md">
                ...
                <div class="card-media-list">
                    ...
                    <div class="media clickable" data-qp-link="task-list.html">
                        ...
                        <div class="media-body">
                            <div class="heading mt-1">
                                A task was escalated from <span class="badge badge-info">Low priority</span>
                                to <span class="badge badge-danger">Urgent</span>.
                            </div>
