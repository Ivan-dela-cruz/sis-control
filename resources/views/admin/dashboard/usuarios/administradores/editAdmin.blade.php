    ...
    <div class="row">
        <div class="col-md-12">
            <p class="font-italic text-lg-right">
                <a href="{{route('usuario.index')}}">Administradores</a>/Editar usuario - {{$user->cedula_p}}
            </p>
        </div>
    </div>
    <div class="row mb-5">
                            ...
                            <div class="row pb-5">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" maxlength="10" class="form-control" id="cedula_p"
                                               name="cedula_p"
                                        ...
                                        @endif
                                        <label hidden id="lb-cedula-ecuador" class="text-danger">El número de cédula no
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="remember"
                                                       id="remember">
                                                <label class="form-check-label text-priamry" for="remember">
                                                    Cambiar contraseña
                                                </label>
                                            </div>
                                        </div>
