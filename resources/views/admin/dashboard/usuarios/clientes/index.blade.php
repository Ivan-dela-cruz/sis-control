...
@section('content')
    ...
    <div class="row mb-5">
        <div class="col-md-12">
            <div class="card-header bg-dark bg-gradient">
                <p class="lead">
                    Clientes
                    <a class="btn btn-outline-white btn-sm pull-right" href="{{route('clientes.create')}}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-7">
                            {!! Form::open(['route' => 'clientes.index', 'method'=>'GET','autocomplete'=>'off','role'=>'search']) !!}
    ...
    @include('admin.dashboard.usuarios.clientes.modalsCliente')
@endsection
