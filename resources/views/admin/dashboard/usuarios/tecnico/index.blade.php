...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <a href="{{route('tecnicos.index')}}" class="font-italic pull-right">Técnicos/</a>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
            <div class="card-header bg-dark bg-gradient">
                <p class="lead">
                    Técnicos
                    <a class="btn btn-outline-white btn-sm pull-right" href="{{route('tecnicos.create')}}">
                                        ...
                                        <tr class="usuario{{$tecnico->id}}">
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{route('tecnicos.edit',$tecnico->id)}}"
                                                   data-id-user="{{$tecnico->id}}" class="btn  btn-warning btn-sm">
