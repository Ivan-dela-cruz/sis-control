    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="direccion_p" id="direccion_p"
                   ...
                   placeholder="Ingrese su dirección" value="{{ $tecnico->user->direccion_p}}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" id="name"
                   ...
                   placeholder="Ingrese el nombre de usuario" value=" {{ $tecnico->user->name}}">
            @if($errors->has('name'))
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {{Form::select('tipo_t',array(
                                   '0' => 'Principal',
                                   '1' => 'Secundario',
                                   ),$tecnico->tipo_t,['id'=>'tipo_t','class'=>'form-control'])}}
