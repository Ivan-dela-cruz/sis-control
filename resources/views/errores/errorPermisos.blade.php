            ...
            <main class="main-content p-5" role="main">
                <div class="row">
                    <div class="col-md-12 my-5 text-center">
                        ...
                        <div class="lead">You are seeing this page because there is an error with our server.</div>
                        ...
                        <div class="lead mt-5"><a href="error-pages-404.html"><i class="batch-icon batch-icon-arrow-left"></i> Click here to check out the 404 page.</a></div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-md-12">
